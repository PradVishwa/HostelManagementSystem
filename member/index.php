...
if (isset($_POST['login'])) {
    ...
    $query = "SELECT * FROM `tbl_member` WHERE member_email='$email'";
    $res = mysqli_query($con, $query);
    if ($res) {
        $result_fetch = mysqli_fetch_assoc($res);

        if ($password == $result_fetch['member_pass'] && $email == $result_fetch['member_email']) {
        ...
        <div class="container ">
            <div class="row login">
                <div class="col-lg-5 p-0">
                    <img src="../assets/img/gallery/member_new.jpg" class="img-fluid w-100 h-100" alt="">
                </div>
